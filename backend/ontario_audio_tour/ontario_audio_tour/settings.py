"""
Django settings for ontario_audio_tour project.
...
SECRET_KEY = 'django-insecure-xm#&dh5r&ga5m$hu$r*ubqyge!g9-(=dh@l!g6176$65jrj-x%'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # yilz: add corsheaders
]
...
LOGIN_URL="/AdminControl/accounts/login"
LOGIN_REDIRECT_URL = "/AdminControl/profile/"

"""Superuser:
Username: superAdmin
Email: hejingy4@mail.utoronto.ca
Password: csc301
"""